...
if __name__=="__main__":
    ...
    for index, row in df.iterrows():
        ...
        # besoin que fonction principale de détection renvoie : nombre_de_pieces , valeur_calculéé
        #___________A DECOMMENTER QUAND VALEURS RETOURNÉES_____________________________
        
        #res_nb, res_val = detecter_et_identifier(path)
